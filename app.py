...
tab1, tab2, tab3, tab4 = st.tabs(
    ["📋 Risk Assessment", "🔬 Explainable AI (SHAP)", "🗂️ Patient History Log", "📊 Model Performance"]
)
        ...
        contrib_df = pd.DataFrame(
            {
                ...
                "Direction": [
                    "⬆️ Increases Risk" if sv[i] > 0 else "⬇️ Decreases Risk"
...
st.markdown("---")
st.caption(
    "⚕️ Hospital Patient Risk Prediction System — Demo build using synthetic data. "
